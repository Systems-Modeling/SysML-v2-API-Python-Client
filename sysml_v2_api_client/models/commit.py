...
class Commit(object):
    ...
    openapi_types = {
        'type': 'str',
        'changes': 'list[ElementVersion]',
        'id': 'str',
        'previous_commit': 'Record'
    }
    ...
    def __init__(self, type=None, changes=None, id=None, previous_commit=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def changes(self):
        """Gets the changes of this Commit.  # noqa: E501


        :return: The changes of this Commit.  # noqa: E501
    ...
    def changes(self, changes):
        """Sets the changes of this Commit.


        :param changes: The changes of this Commit.  # noqa: E501
