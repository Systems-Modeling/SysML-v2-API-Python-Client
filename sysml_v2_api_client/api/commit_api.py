...
class CommitApi(object):
    ...
    def post_commit_by_project(self, project_id, body, **kwargs):  # noqa: E501
        ...
        :param str branch_id: ID of the branch - project's default branch if unspecified
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def post_commit_by_project_with_http_info(self, project_id, body, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'branch_id' in local_var_params and local_var_params['branch_id'] is not None:  # noqa: E501
            query_params.append(('branchId', local_var_params['branch_id']))  # noqa: E501
