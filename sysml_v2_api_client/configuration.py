...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of sysml_v2_api_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = sysml_v2_api_client.Configuration(
    ...
    Note you can use the constants defined in the sysml_v2_api_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = sysml_v2_api_client.Configuration(
        signing_info = sysml_v2_api_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("sysml_v2_api_client")
